...
const GROUP_RESULTS: Array<{
  ...
  { matchNumber: 3, scoreHome: 1, scoreAway: 3, goalEvents: [{ teamSide: 'home', playerIndex: 3, minute: 14 }, { teamSide: 'away', playerIndex: 2, minute: 7 }, { teamSide: 'away', playerIndex: 3, minute: 19 }, { teamSide: 'away', playerIndex: 4, minute: 27 }], assistEvents: [{ teamSide: 'away', playerIndex: 4, minute: 7 }] },
  ...
  { matchNumber: 8, scoreHome: 4, scoreAway: 0, goalEvents: [{ teamSide: 'home', playerIndex: 3, minute: 4 }, { teamSide: 'home', playerIndex: 3, minute: 11 }, { teamSide: 'home', playerIndex: 4, minute: 19 }, { teamSide: 'home', playerIndex: 2, minute: 27 }], assistEvents: [{ teamSide: 'home', playerIndex: 4, minute: 4 }, { teamSide: 'home', playerIndex: 1, minute: 11 }] },
